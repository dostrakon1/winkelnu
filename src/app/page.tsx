        ...
        {catalogEnabled && catalogProducts.length > 0 ? (
          <section id="producten" className="wn-container wn-section scroll-mt-6">
            ...
            <div className="relative mt-8 overflow-hidden rounded-[var(--wn-radius-xl)] border border-[color:rgba(18,59,58,0.16)] bg-[var(--wn-petrol-soft)] shadow-[var(--wn-shadow-xs)]">
              <div
                className="absolute inset-0 sm:left-auto sm:right-0 sm:w-[58%]"
                style={{
                  backgroundImage: "url('/images/sections/section-productvergelijker.webp')",
                ...
                aria-hidden="true"
              />
              <div className="absolute inset-0 bg-[rgba(223,233,228,0.78)] sm:bg-transparent" aria-hidden="true" />
              <div className="absolute inset-0 bg-[linear-gradient(90deg,#dfe9e4_0%,rgba(223,233,228,0.98)_43%,rgba(223,233,228,0.78)_57%,rgba(223,233,228,0.26)_70%,rgba(223,233,228,0.05)_84%,rgba(223,233,228,0)_100%)]" aria-hidden="true" />
              <div className="relative z-10 p-5 sm:flex sm:min-h-52 sm:items-center sm:justify-between sm:gap-8 sm:p-6 lg:p-8">
