  ...
  return (
    <main className="min-h-screen bg-[var(--wn-cream)] px-4 py-10 text-[var(--wn-ink)] sm:px-6">
      <div className="mx-auto max-w-3xl">
        <a href="/" className="text-2xl font-bold tracking-tight text-[var(--wn-petrol)]">Winkelnu</a>
        <section className="wn-surface relative mt-10 overflow-hidden p-7 sm:p-10">
          ...
          <div className="relative max-w-xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <a href="/zoeken" className="wn-button wn-button-secondary">Naar producten</a>
            </div>
          </div>
        </section>
      </div>
