  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p className="mt-3">Met Lootje &amp; Lijstje kun je zonder account een verlanglijstje maken of een cadeaugroep starten. Afhankelijk van wat je gebruikt verwerken we de naam die je zelf invult, de gekozen gelegenheid en eventueel een lijst- of groepsnaam, budget, datum, wensen, toelichtingen, externe productlinks, deelnemersnamen en ingestelde uitsluitingen. Na een trekking bewaren we ook de geheime koppeling tussen gever en ontvanger en eventuele privé “geregeld”-markeringen. Een e-mailadres, telefoonnummer of wachtwoord is niet verplicht.</p>
        <p className="mt-3">De volledige trekking wordt niet aan de organisator getoond. Een deelnemer kan via zijn eigen geheime toegang uitsluitend zijn eigen getrokken persoon en diens lijstje opvragen. “Geregeld”-markeringen zijn alleen zichtbaar voor de deelnemer die dat lootje heeft en worden niet aan de ontvanger getoond.</p>
        <p className="mt-3">Gedeelde links, uitnodigingscodes en geheime beheer- of hersteltoegang hebben verschillende doelen. Geheime tokens worden niet leesbaar in de database opgeslagen; daarvan bewaren we alleen een cryptografische hash. Na geldige toegang gebruikt de browser een strikt noodzakelijke, beveiligde first-party cookie om de toegangsrechten op hetzelfde apparaat te onthouden. Deze cookie wordt niet gebruikt voor advertenties of bezoekersprofilering.</p>
        <p className="mt-3">Om geautomatiseerd misbruik van het aanmaken van lijstjes, groepen en deelnames te beperken, gebruikt Winkelnu een tijdelijke first-party rate-limitbucket. De technische verzoekadreswaarde wordt daarvoor met een geheime sleutel gehasht; het ruwe adres wordt niet in de Lootje &amp; Lijstje-database of rate-limittabel opgeslagen. Verouderde rate-limitbuckets worden automatisch opgeschoond.</p>
        <p className="mt-3">Alle routes van Lootje &amp; Lijstje zijn uitgesloten van onze openbare Web Analytics-meting. Daardoor sturen we via die analyticsintegratie geen lijstcodes, groepscodes, herstelcodes, namen, wensen, lootjes of andere inhoud van de module mee. Gedeelde, uitnodigings- en privé pagina’s worden bovendien niet voor indexering door zoekmachines aangeboden; alleen de algemene informatiepagina van Lootje &amp; Lijstje kan publiek vindbaar zijn.</p>
      </section>
      <section>
        <h2 className="text-xl font-bold">Bewaartermijnen van Lootje &amp; Lijstje</h2>
        <p className="mt-3">Een zelfstandig verlanglijstje wordt maximaal 180 dagen na de laatste betekenisvolle wijziging bewaard. Voor een groep met een ingevulde feestdatum geldt als eindpunt 120 dagen na die datum. Een groep zonder datum wordt maximaal 180 dagen na de laatste betekenisvolle activiteit bewaard. De bijbehorende deelnemerslijstjes volgen de bewaartermijn van de groep.</p>
        <p className="mt-3">Verlopen gegevens worden dagelijks automatisch opgeschoond. De eigenaar van een zelfstandig lijstje of de organisator van een groep kan de bijbehorende gegevens bovendien eerder zelf definitief verwijderen via de beheerpagina. Bij het verwijderen van een groep worden ook deelnemers, groepslijstjes, uitsluitingen, trekkingsgegevens en “geregeld”-markeringen verwijderd.</p>
      </section>
      <section>
      ...
      <section>
        ...
        <p className="mt-3">We bewaren gegevens niet langer dan nodig is voor het doel waarvoor ze worden verwerkt, rekening houdend met beveiliging, operationele controle en wettelijke verplichtingen. Voor search-feedbackevents geldt een 90-dagenretentiegrens in de zoekleerlaag. Voor Lootje &amp; Lijstje gelden de specifieke termijnen hierboven en is automatische dagelijkse opschoning ingericht. Als de verwerking of technische configuratie verandert, beoordelen we opnieuw welke bewaartermijnen daarbij passend zijn.</p>
      </section>
      <section>
        <h2 className="text-xl font-bold">Jouw privacyrechten</h2>
        <p className="mt-3">Heb je een vraag over persoonsgegevens of wil je een privacyrecht uitoefenen, neem dan contact op via <a className="font-semibold underline underline-offset-4" href={`mailto:${operator.email}`}>{operator.email}</a>. Omdat Winkelnu geen openbaar klantaccount heeft en veel interacties bewust niet aan een persistent bezoekersprofiel worden gekoppeld, kan het voorkomen dat we weinig gegevens hebben die rechtstreeks aan jou te koppelen zijn. Voor Lootje &amp; Lijstje kun je gegevens waarvoor je nog de juiste beheer-toegang hebt ook rechtstreeks zelf verwijderen.</p>
      </section>
