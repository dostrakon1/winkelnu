...
export function getCommerceEventCampaigns(year: number): readonly CommerceEventCampaign[] {
  ...
  return [
    ...
    },
    {
      ...
      enabled: true,
      href: '/collecties/cyber-monday',
      eyebrow: '✦ Cyber Monday digitale finale',
      title: 'Cyber Monday: rond je shortlist slim af.',
      ...
      bannerLabel: 'Cyber Monday — de digitale finale bij Winkelnu',
      imageSlug: 'elektronica',
      imageLabel: 'Elektronica',
      heroGradient: 'linear-gradient(135deg, #03050a 0%, #07111c 46%, #0a3038 72%, #12626d 100%)',
      accent: '#22bdcc',
      accentSoft: '#baf8ff',
      chips: [
        { label: 'Elektronica', href: '/koopgidsen/categorie/elektronica' },
