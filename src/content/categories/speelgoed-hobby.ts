...
export const speelgoedHobbyCategory = {
  ...
  subcategories: [
    { title: 'Bouwen & constructie', description: 'Sets en systemen waarmee kinderen en volwassenen kunnen bouwen en experimenteren.' },
    { title: 'Creatief & knutselen', description: 'Materialen voor tekenen, schilderen, maken en andere creatieve hobby\'s.' },
    { title: 'Spellen & puzzels', description: 'Activiteiten voor alleen spelen, gezinnen en groepen.' },
    { title: 'Buitenspeelgoed', description: 'Speelgoed voor tuin, park en actieve beweging buiten.' },
    { title: 'Hobby voor volwassenen', description: 'Materialen en sets voor ontspanning, verzamelen en creatief bezig zijn.' },
  ],
  buyingTips: [
