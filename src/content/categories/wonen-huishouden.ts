...
export const wonenHuishoudenCategory = {
  ...
  subcategories: [
    { title: 'Schoonmaken', description: 'Stofzuigen, dweilen en andere hulpmiddelen voor dagelijks onderhoud.' },
    { title: 'Was & drogen', description: 'Apparaten en hulpmiddelen voor wassen, drogen en kledingverzorging.' },
    { title: 'Klimaat in huis', description: 'Ventileren, verwarmen, koelen en luchtkwaliteit.' },
    { title: 'Opbergen & organiseren', description: 'Praktische oplossingen voor een overzichtelijk huishouden.' },
    { title: 'Kleine huishoudelijke apparaten', description: 'Compacte apparaten voor terugkerende taken in huis.' },
  ],
  buyingTips: [
