...
export const dierenCategory = {
  ...
  feedAliases: ['dieren', 'pets', 'pet supplies', 'pet products'],
  topics: ['Formaat en comfort', 'Veiligheid en stevigheid', 'Gedrag en dagelijks gebruik', 'Schoonmaken en onderhoud'],
  subcategories: [
    { slug: 'hond', title: 'Hond', description: 'Manden, riemen, verzorging en praktische producten voor dagelijks gebruik.', feedAliases: ['hond', 'dogs', 'dog supplies', 'dog beds', 'hondenmanden'] },
    { slug: 'kat', title: 'Kat', description: 'Krabben, rusten, spelen en verzorging in en rond het huis.', feedAliases: ['kat', 'cats', 'cat supplies', 'cat furniture', 'krabpalen'] },
    { slug: 'voeren-drinken', title: 'Voeren & drinken', description: 'Bakken, drinkoplossingen en hulpmiddelen rond de dagelijkse voerplek.', feedAliases: ['dieren voeren drinken', 'pet feeding', 'pet bowls', 'pet fountains', 'drinkfonteinen'] },
    { slug: 'dierenverzorging', title: 'Verzorging', description: 'Borstels, nagelverzorging en andere praktische hulpmiddelen.', feedAliases: ['dierenverzorging', 'pet grooming', 'pet care tools', 'grooming brushes'] },
    { slug: 'reizen-vervoer', title: 'Reizen & vervoer', description: 'Producten om huisdieren veilig en praktisch mee te nemen.', feedAliases: ['dieren reizen vervoer', 'pet travel', 'pet carriers', 'transportboxen', 'pet transport'] },
  ],
  buyingTips: [
