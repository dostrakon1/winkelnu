-- Make category filtering hierarchy-aware for the public catalog.
-- A root category includes products assigned directly to itself and to its direct children.
-- A child category remains an exact filter. Winkelnu's managed taxonomy is intentionally two levels deep.
